...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        loadMultiplierFromPreferences(sharedPreferences);
    ...
    private void loadMultiplierFromPreferences(SharedPreferences sharedPreferences){
        Float multiplier = Float.parseFloat(
                sharedPreferences.getString(
                        getString(R.string.pref_multiplier_key),
                        getString(R.string.pref_multiplier_default_value)));
